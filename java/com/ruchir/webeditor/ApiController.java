...
public class ApiController {
	...
	@RequestMapping(value = "/textUpload", method = RequestMethod.GET)
	public String queryUpload(@ModelAttribute("textUpload") String pHtmlText,	Model model) throws Exception {
